...
{
    public class ArithmeticExpression : AST
    {
    	private TimesDiv _timesdiv;
        private ExpressionSign _sign;
        private ArithmeticExpression _next;
    	...
    	{
    		get{ return _timesdiv; }
    		set{ _timesdiv = value; }
    	}
    	
        public ArithmeticExpression()
        {
            _sign = ExpressionSign.None;
            _next = null;
        }
    }
